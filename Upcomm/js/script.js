...
var channelData = [{
	...
	messages: [{
		...
		embedData: {
			title: ' ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎  ‏‏‎‏‏‎ ',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://cdn.discordapp.com/attachments/1011743830824984607/1078384931148943360/aramza_katlmak_ister_misin.png',
		}
	}, {
		type: 'message',
		delay: 350,
	...
	messages: [{
		...
		delay: 350,
		user: users.upcommbot,
		text: 'Yeni Video Yayında!',
		embedData: {
			title: 'YouTube Videomuzu Aşağıdaki Linkten İzleyebilirsiniz! Video Link: https://youtu.be/XSVIjCXHlJY',
			pill: 'hsl(352, 100%, 50%)',
			thumb: 'https://cdn.discordapp.com/attachments/1010866436077531197/1077901429584445501/BIR_GUNUM_NASIL_GECIYOR.png',
			footerIcon: users.user.avatar,
			footer: 'Created By Açelya and Rıdvan'
		}
	},]
}, {
	...
	messages: [{
		...
		delay: 350,
		user: users.upcommbot,
		text: 'Upcomm Yetkili Alım',
		embedData: {
			title: 'Upcomm, bilgisayar biliminden çevresel sürdürülebilirliğe kadar çeşitli konuları tartışmak isteyen mühendisler, geliştiriciler ve teknoloji meraklıları için bir arkadaş canlısı, açık fikirli Discord sunucusudur. Sunucumuzda soru sorabilir, fikir ve bilgi paylaşabilir ve arkadaş edinebilirsiniz. Ancak, büyümekte olan bu topluluğun başarılı bir şekilde yönetilmesi için yetkili kişilerin olması gerekmektedir. İşte bu nedenle, Upcomm sunucusu için yetkili kişiler aramaktayız. Eğer sosyal, açık fikirli ve yardımsever bir kişiyseniz ve teknolojik konular hakkında bilgi sahibiyseniz, bu sizin için mükemmel bir fırsat olabilir. Upcomm sunucusunda yetkili kişi olarak görev yapmak, sizin fikir ve düşüncelerinizi paylaşmanızı ve topluluğun gelişmesine katkıda bulunmanızı sağlar.Eğer bu fırsat ilginizi çekiyorsa ve sunucumuza katkıda bulunmak istiyorsanız, lütfen başvuru formumuza https://forms.gle/qRukc2MVGteXQoCw9 başvurun. İlgilendiğiniz için teşekkür ederiz ve Upcomm topluluğunun büyümesine katkıda bulunmak üzere sabırsızlanıyoruz. Son Başvuru Tarihi: 20.02.2023',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://cdn.discordapp.com/attachments/1010866436077531197/1075045185077117076/YETKILI_KAYITLARIMIZ_ACILMISTIR.gif',
			footerIcon: users.user.avatar,
			footer: 'Created By Açelya and Rıdvan'
		}
	}, {
		...
		delay: 350,
		user: users.upcommbot,
		text: 'Upcomm Sunucusu Yetkili Alım Başvurusundan Seçilen Arkadaşlar',
		embedData: {
			title: 'Upcomm Sunucusu, yazılım alanında faaliyet gösteren bir sunucudur. Yetkili alım başvurusu sürecinde birçok başvuru arasından seçilen arkadaşlar, sunucunun ihtiyaç duyduğu pozisyonlarda görev alacaklar.  Moderatör olarak seçilen @ACAR , sunucunun sohbet kanallarının düzenli ve uygun bir şekilde kullanılmasından sorumlu olacaktır. Moderatör olarak görev yapmak, sunucudaki tartışmaların barışçıl bir şekilde ilerlemesini ve herkesin birbirine saygı göstermesini sağlamak için oldukça önemlidir. @ACAR , sunucunun kurallarının uygun bir şekilde uygulanmasını sağlayacak ve üyelerin sorunlarını çözmek için yardımcı olacaktır.  Admin olarak seçilen @Batu ve @acikgoz.enç ise sunucunun genel yönetiminden sorumlu olacaklardır. Yöneticiler, sunucunun sorunsuz bir şekilde çalışmasını sağlamak için gerekli tüm işlemleri gerçekleştireceklerdir. Sunucunun düzenli bir şekilde güncellenmesi, üyelerin sorunlarının çözülmesi, yeni üyelerin kaydedilmesi ve sunucunun geliştirilmesi gibi işlemler yöneticiler tarafından yürütülecektir.  Seçilen arkadaşlar, Upcomm Sunucusu için oldukça önemli görevlerde yer alacaklar. Sunucunun düzenli ve sorunsuz bir şekilde işlemesi için ellerinden geleni yapacaklar. Upcomm Sunucusu, yazılım alanındaki çalışmalarına hız kesmeden devam ederken, yetkili alım başvurusu sürecinde seçilen arkadaşlar da sunucunun başarısı için önemli bir rol oynayacaklar. Kendilerine yeni pozisyonları için tekrar tebrik ediyor ve başarılar diliyoruz.',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://cdn.discordapp.com/attachments/1010866436077531197/1075347121814917171/Adsz_tasarm.gif',
			footerIcon: users.user.avatar,
			footer: 'Created By Açelya and Rıdvan'
		}
	}, {
		...
		delay: 350,
		user: users.upcommbot,
		text: 'Youtube ve Github Rollerini Artık Alabilirsiniz!',
		embedData: {
			title: 'Merhaba arkadaşlar, sunucumuzda bazı yeni roller oluşturduk ve sizinle bunları paylaşmak istiyoruz. Artık sunucumuzda Github veya Youtube hesabına bağlanarak özel roller kazanabilirsiniz. Bu roller size daha fazla takipçi ve görüntülenme sağlayacaktır. Github hesabınıza bağlandığınızda, @GITHUB rolünü kazanacaksınız. Ayrıca, Youtube hesabınıza bağlandığınızda @YOUTUBE rolünü kazanacaksınız. Bu özel roller sayesinde, sunucumuzda daha fazla etkileşimde bulunabileceksiniz. Rolünüzü almak için lütfen hesaplarınızı bağlayın.',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://cdn.discordapp.com/attachments/1010866436077531197/1075751961137254461/Adsz_tasarm_3.png',
			footerIcon: users.user.avatar,
			footer: 'Created By Açelya and Rıdvan'
		}
	}]
	...
	messages: [{
		...
		user: users.upcommbot,
		embedData: {
			title: 'Upcomm Ekip Arama',
			pill: 'hsl(202, 35%, 68%)',
			thumb: '../img/upcomm-ekip.png',
			footerIcon: users.user.avatar,
			footer: 'Created By Açelya and Rıdvan',
			fields: [{
				name: 'Bu kanal üzerinden ekibinizi kurabilir veya ekip arayabilirsiniz.',
			}, {
				name: 'Projeyi tanımlayabilir misiniz?',
				value: '-'
			}, {
				name: 'Projede hangi roller için ekip arıyorsunuz?',
				value: '-'
			}, {
				name: 'Projede kullanacağınız programlama dilleri ve teknolojileri nelerdir?',
				value: '-'
			}, {
				name: 'Projede kullanacağınız oyun motorları veya yazılımlar nelerdir?',
				value: '-'
			}, {
				name: 'Projenin hedef kitlesi kimlerdir?',
				value: '-'
			}, {
				name: 'Projenin hedeflenen platformları nelerdir? (Örn. PC, mobil, konsol vb.)',
				value: '-'
			}, {
				name: 'Projede kaç kişilik bir ekibe ihtiyacınız var?',
				value: '-'
			}, {
				name: 'Projede çalışacak kişilerden beklediğiniz beceriler nelerdir?',
				value: '-'
			}, {
				name: 'Projenin tamamlanması için belirli bir süre planladınız mı?',
				value: '-'
			}, {
				name: 'Ekibinize katılacak kişilerle iletişim için hangi araçları kullanmayı planlıyorsunuz? (Örn. Discord, Slack, E-posta vb.)',
				value: '-'
			}]
		}
	},]
	...
	messages: [{
		...
		user: users.upcommbot,
		embedData: {
			title: "Upcomm'a Kendini Tanıt",
			pill: 'hsl(202, 35%, 68%)',
			thumb: '../img/upcomm-kendini-tanıt.png',
			footerIcon: users.user.avatar,
			footer: 'Created By Açelya and Rıdvan',
			fields: [{
				name: 'Bu kanal üzerinden kendinizi tanıtabilirsiniz.',
			}, {
				name: 'Adınız?',
				value: '-'
			}, {
				...
				name: 'Hangi Yazılım Diliyle İlgileniyorsunuz?',
				value: '-'
			}, {
				name: 'Hedefleriniz veya Yapmak İstediğiniz Neler?',
				value: '-'
			}, {
				name: 'İleride Ulaşmak İstediğiniz Konum Nedir?',
				value: '-'
			}]
		}
	},]
	...
	messages: [{
		...
		user: users.upcommbot,
		embedData: {
			title: "Upcomm'da Yardım Almak İçin Discord Topluluk Sunucumuza Katılın! https://discord.com/upcomm/ ",
			pill: 'hsl(202, 35%, 68%)',
